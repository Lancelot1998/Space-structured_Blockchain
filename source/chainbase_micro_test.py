...
from source.blockchain import Blockchain, Block, TransPool, LightBlock, BlockData, TransOutput, \
    TransInput, Transaction, MacroBlockBody, MacroBlockHeader, MacroChain, MicroBlock
    ...
    def processor_micro_block_write(self, content):
        try:
            ...
            if result:
                ...
                print("chain length1 = ", self.server.macro_chain.micro_block_num + 1)
                print('real length = ', len(self.server.macro_chain.micro_block_pool))
